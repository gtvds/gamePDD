...
{
    public partial class Form_lvl_2 : Form
    {
        public Form_lvl_2()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            command1.Parameters.AddWithValue("@Answer_questions", "По дороге");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Questions] VALUES(@Answer_questions, @Correct_question, @id_test) ", cn);
            command1.Parameters.AddWithValue("@Answer_questions", "По тротуару");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Questions] VALUES(@Answer_questions, @Correct_question, @id_test) ", cn);
            command1.Parameters.AddWithValue("@Answer_questions", "Везде");
            command1.Parameters.AddWithValue("@Correct_question", "False");
            command1.Parameters.AddWithValue("@id_test", label1.Text);
            command1.ExecuteNonQuery();
            cn.Close();
        ...
        private void Form1_lvl1_2_Load(object sender, EventArgs e)
        {
