...
{
    public partial class Form_lvl_3 : Form
    {
        public Form_lvl_3()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            command1.Parameters.AddWithValue("@Answer_questions", "Отвлекать водителя");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Questions] VALUES(@Answer_questions, @Correct_question, @id_test) ", cn);
            command1.Parameters.AddWithValue("@Answer_questions", "Вести себя тихо");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Questions] VALUES(@Answer_questions, @Correct_question, @id_test) ", cn);
            command1.Parameters.AddWithValue("@Answer_questions", "Уступать место пожилым");
            command1.Parameters.AddWithValue("@Correct_question", "False");
            command1.Parameters.AddWithValue("@id_test", label1.Text);
            command1.ExecuteNonQuery();
            cn.Close();
        ...
        private void Form_lvl1_3_Load(object sender, EventArgs e)
        {
