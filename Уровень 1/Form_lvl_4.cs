...
{
    public partial class Form_lvl_4 : Form
    {
        public Form_lvl_4()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            command1.Parameters.AddWithValue("@Answer_questions", "На специальных площадках");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Questions] VALUES(@Answer_questions, @Correct_question, @id_test) ", cn);
            command1.Parameters.AddWithValue("@Answer_questions", "В любом месте, где удобно");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Questions] VALUES(@Answer_questions, @Correct_question, @id_test) ", cn);
            command1.Parameters.AddWithValue("@Answer_questions", "На проезжей части дороги");
            command1.Parameters.AddWithValue("@Correct_question", "False");
            command1.Parameters.AddWithValue("@id_test", label1.Text);
            command1.ExecuteNonQuery();
            cn.Close();
        ...
        private void Form_lvl1_4_Load(object sender, EventArgs e)
        {
