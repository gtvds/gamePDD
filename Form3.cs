...
namespace gamePDD
{
    public partial class Form_Registraton : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            SqlCommand command1 = new SqlCommand("INSERT INTO [Users] VALUES(@Surname,@Name,@Patronymic,@Birthday,@Pol,@Phone)", cn);
            SqlCommand command2 = new SqlCommand("INSERT INTO [Autorize_Users] VALUES(@Login,@Password,@Type)", cn);
                ...
                command1.Parameters.AddWithValue("@Patronymic", textBox3.Text);
                command1.Parameters.AddWithValue("@Birthday", dateTimePicker1.Value);
                command1.Parameters.AddWithValue("@Pol", textBox5.Text);
                command1.Parameters.AddWithValue("@Phone", textBox6.Text);
